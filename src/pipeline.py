...
def run_query(query: str, search: HybridSearch, reranker: CrossEncoderReranker) -> tuple[str, list[str]]:
    ...
    try:
        ...
        resp = client.chat.completions.create(
            ...
            messages=[
                {"role": "system", "content": "Bạn là một trợ lý ảo. Trả lời câu hỏi CHỈ dựa trên context được cung cấp. Cố gắng trả lời trực tiếp, rõ ràng. Nếu trong context không có thông tin để trả lời, CHỈ nói 'Không tìm thấy.'"},
