...
class DenseSearch:
    ...
    def index(self, chunks: list[dict], collection: str = COLLECTION_NAME) -> None:
        ...
        # use smaller model for fast testing if needed, or stick to EMBEDDING_MODEL
        encoder = self._get_encoder()
        vectors = encoder.encode(texts)
        
        # If encoder output size is different from EMBEDDING_DIM, use actual size
    ...
    def search(self, query: str, top_k: int = DENSE_TOP_K, collection: str = COLLECTION_NAME) -> list[SearchResult]:
        ...
        try:
            ...
            return [
                SearchResult(text=hit.payload["text"], score=float(hit.score), 
